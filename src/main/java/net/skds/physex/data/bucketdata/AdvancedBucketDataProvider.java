...
public class AdvancedBucketDataProvider implements ICapabilitySerializable<CompoundNBT> {

	public static final ResourceLocation CHUNK_RL = new ResourceLocation(PhysEX.MOD_ID, "ffldata");
	
	@CapabilityInject(AdvancedBucketData.class)
	public static final Capability<AdvancedBucketData> CHUNK_CAPABILITY = null;
	private AdvancedBucketData instance = CHUNK_CAPABILITY.getDefaultInstance();

	public final LazyOptional<AdvancedBucketData> LOPG; //some reference...

	
	public AdvancedBucketDataProvider() {
